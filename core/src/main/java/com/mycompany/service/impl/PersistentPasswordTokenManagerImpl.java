...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see com.mycompany.service.impl.PasswordTokenManager#generateRecoveryToken(com.mycompany.model.User)
     */
    @Override
    ...
    /**
     * @see com.mycompany.service.impl.PasswordTokenManager#isRecoveryTokenValid(com.mycompany.model.User, java.lang.String)
     */
    @Override
